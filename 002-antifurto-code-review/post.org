...
It contains all the controllers, that are described in the [[Controllers]] section,
and the implementation details are hidden from the header file behind a [[https://herbsutter.com/gotw/_100/][Pimpl]].
