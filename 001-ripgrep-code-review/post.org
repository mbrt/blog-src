...
Note that I took out the comments to make it shorter. As you can see, there is a
...
buffer contents before that location is written, the option applied, and so on,
