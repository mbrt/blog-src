...
1.  [Introduction](#org1d7a608)
2.  [The big picture](#orgc7ce7b2)
3.  [Main](#org525ea32)
    1.  [Mono thread](#org9599bc8)
4.  [The file listing](#org6d0c8a4)
    1.  [Ignore patterns](#org0bac7f8)
5.  [The search process](#org6de299c)
    1.  [The grep crate](#orgcc80a32)
6.  [Output handling](#org4eb7058)
7.  [Concluding remarks](#org0eca5e9)
    1.  [Feedback](#org396ab60)
...
`WithLineNumber` adds line information to an `Error`<sup><a id="fnr.1"
class="footref" href="#fn.1">1</a></sup>. Then the
...
burden to implement error types to a minimum.<sup><a id="fnr.2" class="footref"
href="#fn.2">2</a></sup>
...
give it a brief look:<sup><a id="fnr.3" class="footref" href="#fn.3">3</a></sup>
...
file, and it's used only when a stream would be slower.<sup><a id="fnr.4"
class="footref" href="#fn.4">4</a></sup> This module reuses some types provided
...
everything (by slowing down compilation).<sup><a id="fnr.5" class="footref"
href="#fn.5">5</a></sup>
...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> In this case `Box<Error>`, since a
recursive type cannot embed itself, otherwise it would be impossible to compute
the size of the type.

<sup><a id="fn.2" href="#fnr.2">2</a></sup> You can find a good reference on the
error handling topic in [the Rust
book](https://doc.rust-lang.org/stable/book/error-handling.html).

<sup><a id="fn.3" href="#fnr.3">3</a></sup> Please bear in mind that I have
taken out the comments to make it shorter.

<sup><a id="fn.4" href="#fnr.4">4</a></sup> Generally this happens when
searching into a single huge file.

<sup><a id="fn.5" href="#fnr.5">5</a></sup> See [When should I use
